...
describe('trimTimeSeriesDataFrames()', () => {
  ...
  it('excludes data of PropertyValue query', () => {
    ...
    const dataFrames = trimTimeSeriesDataFrames([cachedQueryInfo], absolutionRange);
  ...
  it.each([
    ...
    const dataFrames = trimTimeSeriesDataFramesEnding([cachedQueryInfo], absolutionRange);
